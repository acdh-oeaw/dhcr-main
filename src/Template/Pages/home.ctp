...
<html lang="en">
    ...
    <body class="home">
        ...
        <script src="<?= Router::url('/js/jquery-3.3.1.slim.min.js', true) ?>" type="application/javascript"></script>
        <!--
        ...
        <!--<script src="<?= Router::url('/js/slick.min.js', true) ?>" type="application/javascript" ></script>-->
