...
class LogentriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'source_name' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'subject' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'logentry_code_id' => 1,
                'user_id' => 1,
                'source_name' => 'Lorem ipsum dolor sit a',
                'subject' => 'Lorem ipsum dolor sit a',
                'description' => 'Lorem ipsum dolor sit amet',
                'cleared' => 1,
                'created' => '2022-07-20 22:19:31',
            ],
        ];
        parent::init();
    }
