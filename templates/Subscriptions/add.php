...
//  disable title when embedded as element in pages, follow
if (!($this->request->getParam('controller') == 'Pages' && $this->request->getParam('action') == 'follow')) {
    echo '<h2>Create your Course Alert</h2>';
}
?>
<ul>
