    ...
    <div class="column-responsive column-80">
        ...
        <div class="courses form content">
            ...
            <fieldset>
                ...
                echo $this->Form->control('access_requirements', ['label' => 'Entry Requirements [English only]', 'placeholder' => 'For instance: if you want to enroll in this MA module, you need to hold a BA degree in X, Y, Z']);
            ...
            <p>&nbsp;</p>
            <?= $this->Form->button($course_submit_label1, ['name' => 'submit1']) ?>
            <p></p>
            <?= $this->Form->button($course_submit_label2, ['name' => 'submit2']) ?>
            <?= $this->Form->end() ?>
        </div>
    </div>
</div>
