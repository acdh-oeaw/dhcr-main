    ...
    <div class="column-responsive column-80">
        ...
        <div class="courses form content">
            ...
            <fieldset>
                ...
                echo $this->Form->control('course_type_id', ['label' => 'Education Type', 'options' => ['1', '2'], 'empty' => true]);
                echo $this->Form->control('language_id', ['label' => 'Language', 'options' => ['1', '2'], 'empty' => true]);
                ?>
                <p>&nbsp;</p>
                ...
                [year]-[month]-[day] and invalidate the course entry after their expiry. Multiple dates can be separated by semicolon. The 
                course will disappear from the list, after the last one-off date has expired:
                <?php
                ...
                echo $this->Form->control('course_duration_unit_id', ['label' => 'Duration type']);
                ...
                echo $this->Form->control('institution_id', ['label' => 'Disciplines']);
                echo $this->Form->control('institution_id', ['label' => 'Tadirah Techniques']);
                echo $this->Form->control('institution_id', ['label' => 'Tadirah Objects']);
                ?>
                <p>&nbsp;</p>
